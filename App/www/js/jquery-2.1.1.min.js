...
!(function(a, b) {
  ...
  var t = (function(a) {
    ...
    try {
      I.apply((F = J.call(v.childNodes)), v.childNodes), F[
        v.childNodes.length
      ].nodeType;
    } catch (eb) {
      I = {
      ...
      if (p && !e) {
        if ((f = _.exec(a)))
          if ((j = f[1])) {
            ...
            if (
              (j = f[3]) && c.getElementsByClassName && b.getElementsByClassName
            )
              return I.apply(d, b.getElementsByClassName(j)), d;
          }
        if (c.qsa && (!q || !q.test(a))) {
          if (
            ((s = (r = u)), (w = b), (x = 9 === k && a), 1 === k &&
              'object' !== b.nodeName.toLowerCase())
          ) {
            (o = g(a)), (r = b.getAttribute('id'))
              ? (s = r.replace(bb, '\\$&'))
              : b.setAttribute('id', s), (s = "[id='" +
              s +
              "'] "), (l = o.length);
            while (l--)
              o[l] = s + qb(o[l]);
    ...
    (c = (fb.support = {})), (f = (fb.isXML = function(a) {
      ...
      return e !== n && 9 === e.nodeType && e.documentElement
        ? ((n = e), (o = e.documentElement), (p = !f(e)), g &&
            g !== g.top &&
            (g.addEventListener
              ? g.addEventListener(
                  'unload',
            ...
            : (delete d.find.ID, (d.filter.ID = function(a) {
                var b = a.replace(cb, db);
                return function(a) {
                  var c = typeof a.getAttributeNode !== C &&
    ...
    for (b in { submit: !0, reset: !0 })
      d.pseudos[b] = mb(b);
    function pb() {}
    (pb.prototype = (d.filters = d.pseudos)), (d.setFilters = new pb()), (g = (fb.tokenize = function(
      a,
      b
    ) {
    ...
    function vb(a, b, c, d, e, f) {
      return d && !d[u] && (d = vb(d)), e &&
        !e[u] &&
        (e = vb(e, f)), hb(function(f, g, h, i) {
        var j,
          k,
          l,
          m = [],
        ...
        if (f) {
          ...
          (r = ub(r === g ? r.splice(o, r.length) : r)), e
            ? e(null, g, r, i)
            : I.apply(g, r);
      });
    }
  ...
  (n.Callbacks = function(a) {
    ...
    var b,
      ...
      j = function(l) {
        for (
          (b = a.memory && l), (c = !0), (g = e ||
            0), (e = 0), (f = h.length), (d = !0);
          h && f > g;
          g++
        )
    ...
    trigger: function(b, c, d, e) {
      ...
      if (
        ...
        while ((g = p[f++]) && !b.isPropagationStopped())
          ...
          })[b.type] && L.get(g, 'handle')), m && m.apply(g, c), (m = k &&
            g[k]), m &&
            m.apply &&
            n.acceptData(g) &&
  ...
  function nb(a, b) {
    ...
    if (1 === b.nodeType) {
      if (
        L.hasData(a) && ((f = L.access(a)), (g = L.set(b, f)), (j = f.events))
      ) {
        ...
        if (((e = a[m]), e || 0 === e))
          if ('object' === n.type(e))
            ...
            (f = f || k.appendChild(b.createElement('div'))), (g = (bb.exec(
              ...
              .toLowerCase()), (h = ib[g] || ib._default), (f.innerHTML = h[1] +
              e.replace(ab, '<$1></$2>') +
              h[2]), (j = h[0]);
            while (j--)
              f = f.lastChild;
    ...
    return c ||
      ((c = sb(a, b)), ('none' !== c && c) ||
        ((qb = (qb || n("<iframe frameborder='0' width='0' height='0'/>"))
          .appendTo(b.documentElement)), (b = qb[
          0
        ].contentDocument), b.write(), b.close(), (c = sb(
          a,
          b
        )), qb.detach()), (rb[a] = c)), c;
  }
  ...
  function Ib(a, b, c) {
    ...
    if (0 >= e || null == e) {
      if (
        ((e = xb(a, b, f)), (0 > e || null == e) && (e = a.style[b]), vb.test(
          e
        ))
      )
        return e;
    ...
    style: function(a, b, c, d) {
      if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
        ...
        return (b = n.cssProps[h] ||
          (n.cssProps[h] = Fb(i, h))), (g = n.cssHooks[b] ||
    ...
    ajax: function(a, b) {
      ...
      if (
        ((o.promise(
          ...
          fc) + '')
          .replace(gc, '')
          .replace(lc, ec[1] + '//')), (k.type = b.method ||
          b.type ||
          k.method ||
          ...
          ((h = mc.exec(k.url.toLowerCase())), (k.crossDomain = !(!h ||
            (h[1] === ec[1] &&
              h[2] === ec[2] &&
              (h[3] || ('http:' === h[1] ? '80' : '443')) ===
                (ec[3] || ('http:' === ec[1] ? '80' : '443')))))), k.data &&
          k.processData &&
          'string' != typeof k.data &&
          (k.data = n.param(k.data, k.traditional)), sc(nc, k, b, v), 2 === t)
      )
        return v;
      (i = k.global), i &&
        0 === n.active++ &&
        n.event.trigger(
          'ajaxStart'
        ), (k.type = k.type.toUpperCase()), (k.hasContent = !kc.test(
        k.type
          ...
          ((t = 2), g && clearTimeout(g), (c = void 0), (e = h ||
            ...
            ? (k.ifModified &&
                ((w = v.getResponseHeader('Last-Modified')), w &&
                  (n.lastModified[d] = w), (w = v.getResponseHeader(
                  'etag'
                )), w && (n.etag[d] = w)), 204 === a || 'HEAD' === k.type
                ? (x = 'nocontent')
                : 304 === a
                    ? (x = 'notmodified')
      ...
      return n.isFunction(a)
        ...
        : (this[0] &&
            ((b = n(a, this[0].ownerDocument).eq(0).clone(!0)), this[
              0
            ].parentNode && b.insertBefore(this[0]), b
              .map(function() {
                var a = this;
  ...
  a.ActiveXObject &&
    ...
    'withCredentials' in
      Fc), (k.ajax = (Fc = !!Fc)), n.ajaxTransport(function(a) {
    var b;
            ...
            (b = function(a) {
              return function() {
                b &&
                  (delete Dc[
                    g
                  ], (b = (f.onload = (f.onerror = null))), 'abort' === a
                    ? f.abort()
                    : 'error' === a
  ...
  n.ajaxSetup({
    ...
    return h || 'jsonp' === b.dataTypes[0]
      ? ((e = (b.jsonpCallback = n.isFunction(b.jsonpCallback)
          ...
          (a[
            e
          ] = f), b[e] && ((b.jsonpCallback = c.jsonpCallback), Gc.push(e)), g && n.isFunction(f) && f(g[0]), (g = (f = void 0));
        }), 'script')
      : void 0;
      ...
      if (f)
        return (b = f.documentElement), n.contains(b, d)
          ? (typeof d.getBoundingClientRect !== U &&
              (e = d.getBoundingClientRect()), (c = Kc(f)), {
