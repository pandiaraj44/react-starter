(jQuery.easing.jswing = jQuery.easing.swing), jQuery.extend(jQuery.easing, {
  ...
  easeInOutBack: function(a, b, c, d, e, f) {
    return void 0 == f && (f = 1.70158), (b /= e / 2) < 1
  ...
  if (!a.jQuery) {
    ...
    (c.isWindow = function(a) {
      ...
      for (
        'boolean' == typeof h &&
          ((k = h), (h = arguments[i] || {}), i++), 'object' != typeof h &&
          'function' !== c.type(h) &&
          (h = {}), i === j && ((h = this), i--);
        j > i;
        i++
            ...
            (a = h[e]), (d = f[e]), h !== d &&
              (k && d && (c.isPlainObject(d) || (b = c.isArray(d)))
                ? (b
                    ...
                    : (g = a && c.isPlainObject(a) ? a : {}), (h[e] = c.extend(
                    k,
                    g,
                    d
                  )))
      ...
      c.each(a.nodeType ? [a] : a, function(a, d) {
        ...
        'inprogress' === f && (f = e.shift()), f &&
          ('fx' === b && e.unshift('inprogress'), f.call(d, function() {
            c.dequeue(d, b);
          }));
      });
    }), (c.fn = (c.prototype = {
      ...
      position: function() {
        ...
        var b = this[0],
          ...
          e = /^(?:body|html)$/i.test(a.nodeName)
            ? { top: 0, left: 0 }
            : c(a).offset();
        return (d.top -= parseFloat(b.style.marginTop) ||
          0), (d.left -= parseFloat(b.style.marginLeft) || 0), a.style &&
          ((e.top += parseFloat(a.style.borderTopWidth) ||
            0), (e.left += parseFloat(a.style.borderLeftWidth) || 0)), {
          top: d.top - e.top,
          left: d.left - e.left,
        };
      },
  ...
  return (function(a, b, c, d) {
    ...
    function i(a, c, d, e) {
      ...
      function m(b, c, e) {
        ...
        do (g = c +
            (e - c) /
              2), (f = i(g, a, d) - b), f > 0 ? (e = g) : (c = g); while (Math.abs(f) > r && ++h < s);
        return g;
      }
      function n(b) {
      ...
      (a = Math.min(
        a,
        1
      )), (d = Math.min(d, 1)), (a = Math.max(a, 0)), (d = Math.max(d, 0));
      var x = v ? new Float32Array(t) : new Array(t),
        y = !1,
        z = function(b) {
          return y || o(), a === c && d === e
            ? b
            : 0 === b ? 0 : 1 === b ? 1 : i(n(b), c, e);
        };
    ...
    function j(a, b) {
      ...
      return p.isString(a)
        ? t.Easings[a] || (c = !1)
        : (c = p.isArray(a) && 1 === a.length
            ? h.apply(null, a)
            : p.isArray(a) && 2 === a.length
                ? u.apply(null, a.concat([b]))
                : p.isArray(a) && 4 === a.length
                    ? i.apply(null, a)
                    : !1), c === !1 && (c = t.Easings[t.defaults.easing] ? t.defaults.easing : s), c;
    }
    function k(a) {
      if (a) {
          ...
          if (t.State.calls[f]) {
            ...
            for (
              ...
              if (g(y)) {
                var z = !1;
                if (
                  j.display !== d && null !== j.display && 'none' !== j.display
                ) {
                  if ('flex' === j.display) {
                    var A = [
                      '-webkit-box',
                ...
                j.mobileHA &&
                  ...
                  ((g(
                    y
                  ).transformCache.translate3d = '(0px, 0px, 0px)'), (z = !0)), z &&
                  v.flushTransformCache(y);
              }
            }
            j.display !== d &&
              'none' !== j.display &&
              (t.State.calls[f][2].display = !1), j.visibility !== d &&
              'hidden' !== j.visibility &&
              (t.State.calls[f][2].visibility = !1), j.progress &&
              j.progress.call(
                h[1],
                h[1],
                r,
    ...
    function l(a, b) {
      ...
      for (
        ...
        if (
          (b ||
            f.loop ||
            ('none' === f.display &&
              v.setPropertyValue(l, 'display', f.display), 'hidden' ===
              f.visibility &&
              v.setPropertyValue(l, 'visibility', f.visibility)), f.loop !==
            !0 &&
            (m.queue(l)[1] === d ||
          ...
          m.each(v.Lists.transforms3D, function(a, b) {
            ...
            ((n = !0), delete g(l).transformCache.translate3d), n &&
            v.flushTransformCache(l), v.Values.removeClass(
            l,
            'velocity-animating'
          );
        }
        ...
        h && f.loop !== !0 && h(e), g(l) &&
          ...
          (m.each(g(l).tweensContainer, function(a, b) {
            /^rotate/.test(a) &&
              ...
              ((b.endValue = 0), (b.startValue = 360)), /^backgroundPosition/.test(a) && 100 === parseFloat(b.endValue) && '%' === b.unitType && ((b.endValue = 0), (b.startValue = 100));
          }), t(l, 'reverse', {
            loop: !0,
            delay: f.delay,
      ...
      t.State.calls[a] = !1;
      for (var p = 0, q = t.State.calls.length; q > p; p++) if (
          t.State.calls[p] !== !1
        ) {
          i = !0;
          break;
      ...
      n = (function() {
        ...
        for (var a = 7; a > 4; a--) {
          ...
          if (
            ((b.innerHTML = '<!--[if IE ' +
              a +
              ']><span></span><![endif]-->'), b.getElementsByTagName(
              'span'
            ).length)
          )
            return (b = null), a;
      ...
      o = (function() {
        ...
        return b.webkitRequestAnimationFrame ||
          ...
          function(b) {
            ...
            return (c = Math.max(0, 16 - (d - a))), (a = d + c), setTimeout(
              function() {
                b(d + c);
              },
              c
    ...
    b.pageYOffset !== d
      ...
      : ((t.State.scrollAnchor = c.documentElement ||
          c.body.parentNode ||
          c.body), (t.State.scrollPropertyLeft = 'scrollLeft'), (t.State.scrollPropertyTop = 'scrollTop'));
    var u = (function() {
      function a(a) {
      ...
      return function d(a, b, e) {
        var f,
          ...
          m = 0.016;
        for (
          (a = parseFloat(a) || 500), (b = parseFloat(b) || 20), (e = e ||
            null), (i.tension = a), (i.friction = b), (f = null !== e), f
            ? ((k = d(a, b)), (g = k / e * m))
            : (g = m);
          (h = c(h || i, g)), j.push(1 + h.x), (k += 16), Math.abs(h.x) > l &&
            Math.abs(h.v) > l;
    ...
    var v = (t.CSS = {
      ...
      Hooks: {
        ...
        register: function() {
          ...
          if (n)
            for (c in v.Hooks.templates) {
              ...
              'Color' === e[0] &&
                (e.push(e.shift()), f.push(f.shift()), (v.Hooks.templates[c] = [
                  e.join(' '),
                  f.join(' '),
                ]));
            }
        ...
        cleanRootPropertyValue: function(a, b) {
          return v.RegEx.valueUnwrap.test(b) &&
            (b = b.match(v.RegEx.valueUnwrap)[1]), v.Values.isCSSNullValue(b) &&
        ...
        injectValue: function(a, b, c) {
          ...
          if (d) {
            ...
            return (c = v.Hooks.cleanRootPropertyValue(
              g,
              c
            )), (e = c.toString().match(v.RegEx.valueSplit)), (e[
              h
            ] = b), (f = e.join(' '));
          }
          return c;
        ...
        registered: {
          clip: function(a, b, c) {
            switch (a) {
              ...
              case 'extract':
                var d;
                return v.RegEx.wrappedValueAlreadyExtracted.test(c)
                  ? (d = c)
                  : ((d = c.toString().match(v.RegEx.valueUnwrap)), (d = d
                      ? d[1].replace(/,(\s+)?/g, ' ')
                      : c)), d;
              case 'inject':
                return 'rect(' + c + ')';
              ...
              v.Normalizations.registered[b] = function(a, c, e) {
                switch (a) {
                  ...
                  case 'inject':
                    ...
                    return f || (g(c).transformCache[b] = '(' + e + ')'), g(
                      c
                    ).transformCache[b];
                }
              };
      ...
      Names: {
        ...
        SVGAttribute: function(a) {
          ...
          return (n || (t.State.isAndroid && !t.State.isChrome)) &&
            (b += '|transform'), new RegExp('^(' + b + ')$', 'i').test(a);
        },
      ...
      getPropertyValue: function(a, c, e, f) {
        function h(a, c) {
          ...
          if (8 >= n)
            ...
            (o = g(a) === d
              ...
              (c = 'borderTopColor'), (i = 9 === n && 'filter' === c
              ? o.getPropertyValue(c)
              : o[c]), ('' === i || null === i) && (i = a.style[c]), e();
          }
        ...
        if (v.Hooks.registered[c]) {
          ...
          var l, o;
          (l = v.Normalizations.registered[c]('name', a)), 'transform' !== l &&
            ((o = h(a, v.Names.prefixCheck(l)[0])), v.Values.isCSSNullValue(
              o
            ) &&
              v.Hooks.templates[c] &&
              (o = v.Hooks.templates[c][1])), (i = v.Normalizations.registered[
            c
          ]('extract', a, o));
        }
        if (!/^[\d-]/.test(i))
        ...
        return v.Values.isCSSNullValue(i) && (i = 0), t.debug >= 2 &&
          console.log('Get ' + c + ': ' + i), i;
      },
      setPropertyValue: function(a, c, d, e, f) {
        ...
        if ('scroll' === c)
          ...
          if (v.Hooks.registered[c]) {
            ...
            (e = e || v.getPropertyValue(a, j)), (d = v.Hooks.injectValue(
              i,
              d,
              e
            )), (c = j);
          ...
          m.each(g(a).transformCache, function(a) {
            /^translate/i.test(a)
              ...
              : /^scale/i.test(a)
                  ? (a = 'scale')
                  : /^rotate/i.test(a) &&
                      (a = 'rotate'), d[a] && ((c += a + '(' + d[a].join(' ') + ') '), delete d[a]);
          });
        } else {
          var e, f;
    ...
    v.Hooks.register(), v.Normalizations.register(), (t.hook = function(
      a,
      b,
      c
    ) {
    ...
    var w = function() {
      ...
      function e() {
        function a(a) {
          function l(a, b) {
            var c = d, e = d, g = d;
            return p.isArray(a)
              ? ((c = a[0]), (!p.isArray(a[1]) && /^[\d-]/.test(a[1])) ||
                  p.isFunction(a[1]) ||
                  v.RegEx.isHex.test(a[1])
                  ? (g = a[1])
                  : ((p.isString(a[1]) && !v.RegEx.isHex.test(a[1])) ||
                      p.isArray(a[1])) &&
                      ((e = b ? a[1] : j(a[1], h.duration)), a[2] !== d &&
                        (g = a[2])))
              : (c = a), b || (e = e || h.easing), p.isFunction(c) &&
              (c = c.call(f, y, x)), p.isFunction(g) && (g = g.call(f, y, x)), [
              c || 0,
              e,
              g,
            ];
          ...
          function r() {
            ...
            if (e && d)
              ...
              var j = g(f).isSVG
                ...
                : c.createElement('div');
              t.init(j), a.myParent.appendChild(j), m.each(
                ...
                'fontSize',
                a.fontSize
              ), t.CSS.setPropertyValue(j, 'boxSizing', 'content-box'), m.each(
                [
                  'minWidth',
                  'maxWidth',
                  'width',
                ...
                'paddingLeft',
                h + 'em'
              ), (i.percentToPxWidth = (I.lastPercentToPxWidth = (parseFloat(
                v.getPropertyValue(j, 'width', null, !0)
              ) || 1) /
                h)), (i.percentToPxHeight = (I.lastPercentToPxHeight = (parseFloat(
                v.getPropertyValue(j, 'height', null, !0)
              ) || 1) / h)), (i.emToPx = (I.lastEmToPx = (parseFloat(
                v.getPropertyValue(j, 'paddingLeft')
              ) || 1) / h)), a.myParent.removeChild(j);
            }
            return null === I.remToPx &&
              (I.remToPx = parseFloat(v.getPropertyValue(c.body, 'fontSize')) ||
                16), null === I.vwToPx &&
              ((I.vwToPx = parseFloat(b.innerWidth) /
                100), (I.vhToPx = parseFloat(b.innerHeight) /
                100)), (i.remToPx = I.remToPx), (i.vwToPx = I.vwToPx), (i.vhToPx = I.vhToPx), t.debug >=
              1 && console.log('Unit ratios: ' + JSON.stringify(i), f), i;
          }
          if (h.begin && 0 === y)
            try {
              h.begin.call(o, o);
          ...
          if ('scroll' === C) {
            ...
            h.container
              ? p.isWrapped(h.container) || p.isNode(h.container)
                  ? ((h.container = h.container[0] ||
                      h.container), (w = h.container['scroll' + D]), (A = w +
                      m(f).position()[D.toLowerCase()] +
                      E))
                  : (h.container = null)
              : ((w = t.State.scrollAnchor[
                  t.State['scrollProperty' + D]
                ]), (z = t.State.scrollAnchor[
                  t.State['scrollProperty' + ('Left' === D ? 'Top' : 'Left')]
            ...
            'none' === g(f).opts.display &&
              (g(f).opts.display = 'auto'), 'hidden' === g(f).opts.visibility &&
              (g(f).opts.visibility = 'visible'), (g(f).opts.loop = !1), (g(
              f
            ).opts.begin = null), (g(f).opts.complete = null), s.easing ||
              delete h.easing, s.duration || delete h.duration, (h = m.extend(
              {},
              g(f).opts,
              h
            ));
            ...
            for (var G in F)
              if ('element' !== G) {
                ...
                (F[G].startValue = (F[G].currentValue = F[G].endValue)), (F[
                  G
                ].endValue = H), p.isEmptyObject(s) ||
                  (F[G].easing = h.easing), t.debug &&
                  console.log(
            ...
            g(f).tweensContainer &&
              g(f).isAnimating === !0 &&
              (F = g(f).tweensContainer), m.each(q, function(a, b) {
            ...
            for (var K in q) {
              ...
              if (
                ...
                ((h.display !== d &&
                  ...
                  !O &&
                  0 !== M &&
                  (O = 0), h._cacheValues && F && F[K]
                  ? (O === d && (O = F[K].endValue + F[K].unitType), (Q = g(
                      f
                    ).rootPropertyValueCache[P]))
                ...
                var R, S, T, U = !1;
                if (
                  ((R = n(K, O)), (O = R[0]), (T = R[1]), (R = n(K, M)), (M = R[
                    0
                  ].replace(/^([+-\/*])=/, function(a, b) {
                    return (U = b), '';
                  })), (S = R[1]), (O = parseFloat(O) || 0), (M = parseFloat(
                    M
                  ) || 0), '%' === S &&
                  ...
                  if (0 === M)
                    ...
                    e = e || r();
                    var V = /margin|padding|left|right|width|text|word|letter/i.test(
                      K
                    ) ||
                      /X$/.test(K) ||
                      'x' === K
                ...
                (i[K] = {
                  ...
                  console.log(
                    'tweensContainer (' + K + '): ' + JSON.stringify(i[K]),
                    f
                  );
              } else
                t.debug &&
          ...
          i.element &&
            (v.Values.addClass(f, 'velocity-animating'), J.push(i), '' ===
              h.queue && ((g(f).tweensContainer = i), (g(f).opts = h)), (g(
              f
            ).isAnimating = !0), y === x - 1
              ? (t.State.calls.push([
                  J,
        ...
        switch ((g(f) === d && t.init(f), parseFloat(h.delay) &&
          h.queue !== !1 &&
        ...
        t.mock !== !1 &&
          (t.mock === !0
            ...
            : ((h.duration *= parseFloat(t.mock) || 1), (h.delay *= parseFloat(
                t.mock
              ) || 1))), (h.easing = j(h.easing, h.duration)), h.begin &&
          !p.isFunction(h.begin) &&
          (h.begin = null), h.progress &&
          !p.isFunction(h.progress) &&
          (h.progress = null), h.complete &&
          !p.isFunction(h.complete) &&
          (h.complete = null), h.display !== d &&
          null !== h.display &&
          ((h.display = h.display.toString().toLowerCase()), 'auto' ===
            h.display &&
            (h.display = t.CSS.Values.getDisplayType(f))), h.visibility !== d &&
          null !== h.visibility &&
          (h.visibility = h.visibility
            .toString()
            .toLowerCase()), (h.mobileHA = h.mobileHA &&
          t.State.isMobile &&
          !t.State.isGingerbread), h.queue === !1
          ? h.delay ? setTimeout(a, h.delay) : a()
      ...
      if (
        ...
        u
          ? ((q = arguments[0].properties || arguments[0].p), (s = arguments[
              0
            ].options || arguments[0].o))
        ...
        switch (q) {
          ...
          case 'stop':
            m.each(o, function(a, b) {
              g(b) &&
                g(b).delayTimer &&
                (clearTimeout(g(b).delayTimer.setTimeout), g(
                  b
                ).delayTimer.next && g(b).delayTimer.next(), delete g(
                  b
                ).delayTimer);
            });
            var D = [];
                    ...
                    : p.isFunction(E.stagger) &&
                        (E.delay = G +
                          E.stagger.call(
                            ...
                            a,
                            x
                          )), E.drag && ((E.duration = parseFloat(F) || (/^(callout|transition)/.test(q) ? 1e3 : r)), (E.duration = Math.max(E.duration * (E.backwards ? 1 - a / x : (a + 1) / x), 0.75 * E.duration, 200))), t.Redirects[q].call(b, b, E || {}, a, x, o, B.promise ? B : d);
                }), a();
              }
              var H = 'Velocity: First argument (' +
                q +
        ...
        if (((E.loop = parseInt(E.loop)), (K = 2 * E.loop - 1), E.loop))
          for (var L = 0; K > L; L++) {
            ...
            L === K - 1 &&
              ((M.display = E.display), (M.visibility = E.visibility), (M.complete = E.complete)), w(
              o,
              'reverse',
              M
            );
    ...
    return t.State.isMobile ||
      ...
      t.Redirects['fade' + b] = function(a, c, e, f, g, h) {
        ...
        (i.complete = e !== f - 1
          ...
          (i.display = 'In' === b ? 'auto' : 'none'), t(this, j, i);
      };
    }), t;
  ...
  function y(a, b) {
    var c = this;
    (this.manager = a), (this.callback = b), (this.element = a.element), (this.target = a.options.inputTarget), (this.domHandler = function(
      b
    ) {
  ...
  function B(a, b) {
    ...
    (b.timeStamp = na()), (b.deltaTime = b.timeStamp -
      f.timeStamp), (b.angle = J(h, i)), (b.distance = I(h, i)), C(
      c,
      b
    ), (b.offsetDirection = H(b.deltaX, b.deltaY)), (b.scale = g
      ? L(g.pointers, d)
  ...
  function C(a, b) {
    ...
    (b.eventType === ya || f.eventType === Aa) &&
      ((e = (a.prevDelta = {
        x: f.deltaX || 0,
        y: f.deltaY || 0,
      })), (d = (a.offsetDelta = { x: c.x, y: c.y }))), (b.deltaX = e.x +
      (c.x - d.x)), (b.deltaY = e.y + (c.y - d.y));
  }
  function D(a, b) {
    var c, e, f, g, h = a.lastInterval || b, i = b.timeStamp - h.timeStamp;
    if (b.eventType != Ba && (i > xa || h.velocity === d)) {
      var j = h.deltaX - b.deltaX, k = h.deltaY - b.deltaY, l = G(i, j, k);
      (e = l.x), (f = l.y), (c = ma(l.x) > ma(l.y) ? l.x : l.y), (g = H(
        j,
        k
      )), (a.lastInterval = b);
    } else
  ...
  function M() {
    (this.evEl = Na), (this.evWin = Oa), (this.allow = !0), (this.pressed = !1), y.apply(
      this,
      arguments
    );
  }
  ...
  function O() {
    (this.evTarget = Ua), (this.evWin = Va), (this.started = !1), y.apply(
      this,
      arguments
    );
  }
  ...
  function W(a) {
    return a & jb
      ? 'cancel'
      : a & hb ? 'end' : a & gb ? 'move' : a & fb ? 'start' : '';
  }
  function X(a) {
    return a == Ga
      ? 'down'
      : a == Fa ? 'up' : a == Da ? 'left' : a == Ea ? 'right' : '';
  }
  function Y(a, b) {
    var c = b.manager;
    return c ? c.get(a) : a;
  ...
  function fa(a, b) {
    (b = b || {}), (this.options = i(
      ...
      a), (this.handlers = {}), (this.session = {}), (this.recognizers = [
    ]), (this.element = a), (this.input = z(this)), (this.touchAction = new T(
      this,
  ...
  y.prototype = {
    ...
    destroy: function() {
      this.evEl && o(this.element, this.evEl, this.domHandler), this.evTarget &&
  ...
  j(M, y, {
    handler: function(a) {
      var b = Ma[a.type];
      b & ya && 0 === a.button && (this.pressed = !0), b & za &&
        1 !== a.which &&
        (b = Aa), this.pressed &&
        this.allow &&
  ...
  a.MSPointerEvent &&
    ((Ra = 'MSPointerDown'), (Sa = 'MSPointerMove MSPointerUp MSPointerCancel')), j(
    N,
    y,
    {
      handler: function(a) {
  ...
  (V.prototype = {
    ...
    recognize: function(a) {
      ...
      return l(this.options.enable, [this, b])
        ? (this.state & (ib | jb | kb) &&
            (this.state = eb), (this.state = this.process(
            b
    ...
    directionTest: function(a) {
      ...
      return e & b.direction ||
        (b.direction & Ha
          ? ((e = 0 === f ? Ca : 0 > f ? Da : Ea), (c = f !=
              this.pX), (d = Math.abs(a.deltaX)))
          : ((e = 0 === g ? Ca : 0 > g ? Fa : Ga), (c = g !=
              this.pY), (d = Math.abs(a.deltaY)))), (a.direction = e), c &&
        d > b.threshold &&
        e & b.direction;
    },
    attrTest: function(a) {
      return Z.prototype.attrTest.call(this, a) &&
    ...
    emit: function(a) {
      this.state === ib &&
        (a && a.eventType & Aa
          ...
          : ((this._input.timeStamp = na()), this.manager.emit(
              this.options.event,
              this._input
            )));
    },
    ...
    attrTest: function(a) {
      ...
      return c & (Ha | Ia)
        ...
        : c & Ha
            ? (b = a.velocityX)
            : c & Ia && (b = a.velocityY), this._super.attrTest.call(this, a) &&
        c & a.direction &&
    ...
    emit: function(a) {
      var b = X(a.direction);
      b && this.manager.emit(this.options.event + b, a), this.manager.emit(
        this.options.event,
        a
      );
    },
    ...
    emit: function() {
      this.state == ib &&
        ((this._input.tapCount = this.count), this.manager.emit(
          this.options.event,
          this._input
        ));
    },
  ...
  (fa.prototype = {
    ...
    destroy: function() {
      this.element && ga(this, !1), (this.handlers = {}), (this.session = {
...
(Vel = $ ? $.Velocity : Velocity), (function(a) {
  (a.fn.collapsible = function(b) {
    ...
    return (b = a.extend(c, b)), this.each(function() {
      ...
      g.off(
        'click.collapse',
        '.collapsible-header'
      ), h.off('click.collapse'), b.accordion ||
        'accordion' === i ||
        void 0 === i
        ? ((h = g.find(
            '> li > .collapsible-header'
    ...
    this.each(function() {
      function d() {
        void 0 !== g.data('induration') &&
          (h.inDuration = g.data(
            'inDuration'
          )), void 0 !== g.data('outduration') && (h.outDuration = g.data('outDuration')), void 0 !== g.data('constrainwidth') && (h.constrain_width = g.data('constrainwidth')), void 0 !== g.data('hover') && (h.hover = g.data('hover')), void 0 !== g.data('gutter') && (h.gutter = g.data('gutter')), void 0 !== g.data('beloworigin') && (h.belowOrigin = g.data('beloworigin')), void 0 !== g.data('alignment') && (h.alignment = g.data('alignment'));
      }
      function e() {
        d(), i.addClass(
          'active'
        ), g.addClass('active'), h.constrain_width === !0 ? i.css('width', g.outerWidth()) : i.css('white-space', 'nowrap');
        var b = 0;
        h.belowOrigin === !0 && (b = g.height());
        var c, e = g.offset().left, f = h.alignment;
        if (
          (e + i.innerWidth() > a(window).width()
            ? (f = 'right')
            : e - i.innerWidth() + g.innerWidth() < 0 &&
                (f = 'left'), 'left' === f)
        )
      ...
      function f() {
        i.fadeOut(
          h.outDuration
        ), i.removeClass('active'), g.removeClass('active');
      }
      var g = a(this),
        h = a.extend({}, c, b),
      ...
      if ((d(), g.after(i), h.hover)) {
        ...
        g.unbind('click.' + g.attr('id')), g.bind(
          'click.' + g.attr('id'),
          function(b) {
            g[0] != b.currentTarget ||
              g.hasClass('active') ||
              ...
              ? g.hasClass('active') &&
                  (f(), a(document).unbind('click.' + i.attr('id')))
              : (b.preventDefault(), e()), i.hasClass('active') &&
  ...
  a.fn.extend({
    openModal: function(c) {
      ...
      var e = {
        ...
        i = ++b;
      h.attr('id', f).css('z-index', 1e3 + 2 * i), g
        .data('overlay-id', f)
        .css('z-index', 1e3 + 2 * i + 1), a('body').append(h), (c = a.extend(
        e,
        c
      )), c.dismissible &&
        (h.click(function() {
      ...
      ), g.data('associated-overlay', h[0]), g.hasClass('bottom-sheet')
        ? g.velocity(
            { bottom: '0', opacity: 1 },
            {
        ...
        : (a.Velocity.hook(g, 'scaleX', 0.7), g.css({
            top: c.starting_top,
          }), g.velocity(
    ...
    closeModal: function(c) {
      var d = { out_duration: 250, complete: void 0 },
        ...
        f = e.data('overlay-id'),
        g = a('#' + f);
      (c = a.extend(d, c)), a('body').css('overflow', ''), e
        .find('.modal-close')
        .off('click.close'), a(document).off('keyup.leanModal' + f), g.velocity(
        { opacity: 0 },
        ...
        ? e.velocity(
            { bottom: '-100%', opacity: 0 },
            {
              ...
              ease: 'easeOutCubic',
              complete: function() {
                g.css({ display: 'none' }), 'function' == typeof c.complete &&
                  c.complete(), g.remove(), b--;
              },
            }
          )
        : e.velocity(
            { top: c.starting_top, opacity: 0, scaleX: 0.7 },
            {
              duration: c.out_duration,
              complete: function() {
                a(this).css('display', 'none'), 'function' ==
                  typeof c.complete && c.complete(), g.remove(), b--;
              },
            }
          );
    },
    ...
    leanModal: function(b) {
      return this.each(function() {
        ...
        a(this).click(function(b) {
          d.starting_top = (a(this).offset().top - a(window).scrollTop()) /
            1.15;
    ...
    return this.each(function() {
      function b() {
        ...
        i.velocity(
          'stop',
          !0
        ), a('#materialbox-overlay').velocity('stop', !0), a('.materialbox-caption').velocity('stop', !0), a(
          '#materialbox-overlay'
        ).velocity(
          { opacity: 0 },
          {
        ...
        ), i.velocity({ width: d, height: g, left: 0, top: 0 }, { duration: h, queue: !1, easing: 'easeOutQuad' }), a(
          '.materialbox-caption'
        ).velocity(
          { opacity: 0 },
          {
            ...
            complete: function() {
              b.css({
                ...
                position: '',
                'z-index': '',
              }), i.removeClass('active'), (f = !0), a(this).remove(), c.css(
                'overflow',
                ''
              );
            },
      ...
      if (!a(this).hasClass('initialized')) {
        ...
        i.wrap(j), i.on('click', function() {
          ...
          for (
            ...
            null !== d && !a(d).is(document);
            
          ) {
            var n = a(d);
            'hidden' === n.css('overflow') &&
              (n.css('overflow', 'visible'), (c = void 0 === c
                ? n
                : c.add(n))), (d = d.parentNode);
          }
          i
          ...
          r > s
            ...
            : ((q = l / m), (t = 0.9 * k * q), (u = 0.9 * k)), i.hasClass(
            'responsive-img'
          )
            ? i.velocity(
                { 'max-width': t, width: l },
  ...
  a.fn.parallax = function() {
    ...
    return this.each(function(c) {
      function d(c) {
        var d;
        d = 601 > b
          ? e.height() > 0 ? e.height() : e.children('img').height()
          : e.height() > 0 ? e.height() : 500;
    ...
    init: function() {
      return this.each(function() {
        ...
        var c,
          ...
          i = 0;
        (c = a(
          e.filter('[href="' + location.hash + '"]')
        )), 0 === c.length && (c = a(this).find('li.tab a.active').first()), 0 === c.length && (c = a(this).find('li.tab a').first()), c.addClass('active'), (i = e.index(c)), 0 > i && (i = 0), (d = a(c[0].hash)), b.append('<div class="indicator"></div>');
        var j = b.find('.indicator');
        if (
          (b.is(':visible') &&
            (j.css({ right: f - (i + 1) * g }), j.css({ left: i * g })), a(
            window
          ).resize(function() {
            ...
            (i = e.index(
              a(this)
            )), 0 > i && (i = 0), d.show(), i - k >= 0 ? (j.velocity({ right: f - (i + 1) * g }, { duration: 300, queue: !1, easing: 'easeOutQuad' }), j.velocity({ left: i * g }, { duration: 300, queue: !1, easing: 'easeOutQuad', delay: 90 })) : (j.velocity({ left: i * g }, { duration: 300, queue: !1, easing: 'easeOutQuad' }), j.velocity({ right: f - (i + 1) * g }, { duration: 300, queue: !1, easing: 'easeOutQuad', delay: 90 })), h.preventDefault();
          }), h >= g)
        ) {
          ...
          document.body.removeChild(k), 0 === l &&
            ((l = 15), b.find('.indicator').css('bottom', l)), b.height(
            a(this).height() + l
          );
        }
      });
  ...
  a.fn.tooltip = function(c) {
    ...
    return 'remove' === c
      ...
      : ((c = a.extend(h, c)), this.each(function() {
          ...
          l.appendTo(
            k
          ), l.css({ top: 0, left: 0 }), i.off('mouseenter.tooltip mouseleave.tooltip'), i.on(
            {
                  ...
                  function() {
                    if (((d += 10), d >= h && e === !1)) {
                      ...
                      var a,
                        ...
                        s = 8;
                      'top' === n
                        ? ((a = i.offset().top - o - g), (c = i.offset().left +
                            j / 2 -
                            p / 2), (f = b(c, a, p, o)), (q = '-10px'), l.css({
                        ...
                        : 'left' === n
                            ...
                            : 'right' === n
                                ...
                                : ((a = i.offset().top +
                                    ...
                                    marginLeft: p / 2 - l.width() / 2,
                                  })), k.css({ top: f.y, left: f.x }), (s = p /
                        8), 8 > s && (s = 8), ('right' === n || 'left' === n) &&
                        ((s = p / 10), 6 > s && (s = 6)), k
                        .velocity(
  ...
  var b = function(b, c, d, e) {
    ...
    return 0 > f
      ? (f = 4)
      : f + d > window.innerWidth && (f -= f + d - window.innerWidth), 0 > g
      ? (g = 4)
      : g + e > window.innerHeight + a(window).scrollTop &&
          (g -= g + e - window.innerHeight), { x: f, y: g };
  };
  a(document).ready(function() {
  ...
  function d(a) {
    ...
    return (b = f.documentElement), 'undefined' !=
      typeof a.getBoundingClientRect && (e = a.getBoundingClientRect()), (d = c(
      f
    )), {
  ...
  function f(a) {
    ...
    for (
      ...
      if (
        !(c instanceof SVGElement || -1 === c.className.indexOf('waves-effect'))
      ) {
        b = c;
        break;
      }
  ...
  function g(b) {
    var c = f(b);
    null !== c &&
      (j.show(b, c), 'ontouchstart' in a &&
        (c.addEventListener('touchend', j.hide, !1), c.addEventListener(
          'touchcancel',
          j.hide,
          !1
        )), c.addEventListener('mouseup', j.hide, !1), c.addEventListener(
        'mouseleave',
        j.hide,
        !1
      ));
  ...
  var h = h || {},
    ...
    j = {
      ...
      show: function(a, b) {
        ...
        'touches' in a &&
          ((h = a.touches[0].pageY - g.top), (i = a.touches[0].pageX -
            g.left)), f.setAttribute('data-hold', Date.now()), f.setAttribute(
          'data-scale',
          k
        ), f.setAttribute('data-x', i), f.setAttribute('data-y', h);
        var l = { top: h + 'px', left: i + 'px' };
        (f.className = f.className + ' waves-notransition'), f.setAttribute(
          'style',
          e(l)
        ), (f.className = f.className.replace('waves-notransition', '')), (l[
          '-webkit-transform'
        ] = k), (l['-moz-transform'] = k), (l['-ms-transform'] = k), (l[
          '-o-transform'
        ] = k), (l.transform = k), (l.opacity = '1'), (l[
          '-webkit-transition-duration'
        ] = j.duration + 'ms'), (l['-moz-transition-duration'] = j.duration +
          'ms'), (l['-o-transition-duration'] = j.duration + 'ms'), (l[
          'transition-duration'
        ] = j.duration + 'ms'), (l[
          '-webkit-transition-timing-function'
        ] = 'cubic-bezier(0.250, 0.460, 0.450, 0.940)'), (l[
          '-moz-transition-timing-function'
        ] = 'cubic-bezier(0.250, 0.460, 0.450, 0.940)'), (l[
          '-o-transition-timing-function'
        ] = 'cubic-bezier(0.250, 0.460, 0.450, 0.940)'), (l[
          'transition-timing-function'
        ] = 'cubic-bezier(0.250, 0.460, 0.450, 0.940)'), f.setAttribute(
          'style',
          e(l)
        );
      },
      hide: function(a) {
        ...
        0 > l && (l = 0), setTimeout(
          function() {
            ...
            c.setAttribute('style', e(a)), setTimeout(
              function() {
                try {
                  b.removeChild(c);
                } catch (a) {
        ...
        for (var b = 0; b < a.length; b++) {
          ...
          if ('input' === c.tagName.toLowerCase()) {
            ...
            f || (f = ''), e.setAttribute(
              'style',
              f
            ), (c.className = 'waves-button-input'), c.removeAttribute(
              'style'
      ...
      allowEvent: function(a) {
        ...
        return 'touchstart' === a.type
          ...
          : 'touchend' === a.type || 'touchcancel' === a.type
              ...
              : 'mousedown' === a.type && k.touches > 0 && (b = !1), b;
      },
      touchup: function(a) {
        k.allowEvent(a);
      },
  ...
  (h.displayEffect = function(b) {
    (b = b || {}), 'duration' in b && (j.duration = b.duration), j.wrapInput(
      i('.waves-effect')
    ), 'ontouchstart' in a &&
    ...
    'input' === b.tagName.toLowerCase() &&
      (j.wrapInput([b]), (b = b.parentElement)), 'ontouchstart' in a &&
      b.addEventListener('touchstart', g, !1), b.addEventListener(
      'mousedown',
      g,
      !1
    );
  ...
  function e(a) {
    ...
    ('object' == typeof HTMLElement
      ...
      ? b.appendChild(a)
      : a instanceof jQuery ? b.appendChild(a[0]) : (b.innerHTML = a);
    ...
    return h.on('pan', function(a) {
      ...
      0 > e &&
        (e = 0), Vel(b, { left: c, opacity: e }, { duration: 50, queue: !1, easing: 'easeOutQuad' });
      ...
      Math.abs(c) > e
        ...
        : (b.classList.remove('panning'), Vel(
            b,
            { left: 0, opacity: 1 },
  ...
  var g = e(a);
  a && f.appendChild(g), (g.style.top = '35px'), (g.style.opacity = 0), Vel(
    g,
    { top: '0px', opacity: 1 },
  ...
  var h = b,
    i = setInterval(
      function() {
        null === g.parentNode && window.clearInterval(i), g.classList.contains(
          'panning'
        ) || (h -= 20), 0 >= h &&
          (Vel(
            g,
            { opacity: 0, marginTop: '-40px' },
            {
              ...
              queue: !1,
              complete: function() {
                'function' == typeof d && d(), this[0].parentNode.removeChild(
                  this[0]
                );
              },
            }
      ...
      (b = a.extend(c, b)), a(this).each(function() {
        function c(c) {
          (g = !1), (h = !1), a('body').css('overflow', ''), a(
            ...
            ? (f.css({ width: '', right: '', left: '0' }), e.velocity(
        ...
        a('body').append(
          f
        ), 'left' == b.edge ? (e.css('left', -1 * (b.menuWidth + 10)), f.css({ left: 0 })) : (e.addClass('right-aligned').css('right', -1 * (b.menuWidth + 10)).css('left', ''), f.css({ right: 0 })), e.hasClass('fixed') && window.innerWidth > 992 && e.css('left', 0), e.hasClass(
          'fixed'
        ) &&
          a(window).resize(function() {
        ...
        f.on('click', function() {
          ...
          .bind('pan', function(d) {
            if ('touch' == d.gesture.pointerType) {
              ...
              if (
                (d.gesture.center.y, d.gesture.velocityX, a('body').css(
                  'overflow',
                  'hidden'
              ...
              var j;
              'left' === b.edge
                ? ((j = f / b.menuWidth), a('#sidenav-overlay').velocity(
                    { opacity: j },
                    { duration: 50, queue: !1, easing: 'easeOutQuad' }
                  ))
                : ((j = Math.abs((f - window.innerWidth) / b.menuWidth)), a(
                    '#sidenav-overlay'
                  ).velocity(
                    { opacity: j },
                    { duration: 50, queue: !1, easing: 'easeOutQuad' }
            ...
            if ('touch' == c.gesture.pointerType) {
              ...
              (g = !1), 'left' === b.edge
                ? (h && 0.3 >= d) || -0.5 > d
                    ...
                    : (!h || d > 0.3) &&
                        (a('body').css('overflow', ''), e.velocity(
                          { left: -1 * (b.menuWidth + 10) },
          ...
          if (h === !0)
            ...
            a('body').css('overflow', 'hidden'), a('body').append(f), 'left' ===
              b.edge
              ? (f.css({ width: '50%', right: 0, left: '' }), e.velocity(
                  { left: 0 },
                  { duration: 300, queue: !1, easing: 'easeOutQuad' }
                ))
              : (f.css({ width: '50%', right: '', left: 0 }), e.velocity(
                  { right: 0 },
                  { duration: 300, queue: !1, easing: 'easeOutQuad' }
                ), e.css('left', ''));
  ...
  function c() {
    ...
    a.each(i, function(a, b) {
      ...
      'number' != typeof c &&
        b.triggerHandler('scrollSpy:enter'), b.data('scrollSpy:ticks', j);
    }), a.each(h, function(a, b) {
      var c = b.data('scrollSpy:ticks');
      'number' == typeof c &&
        c !== j &&
        (b.triggerHandler('scrollSpy:exit'), b.data('scrollSpy:ticks', null));
    }), (h = i);
  }
  function d() {
  ...
  function e(a, b, c) {
    ...
    c || (c = {});
    var i = function() {
      (h = c.leading === !1 ? 0 : l()), (g = null), (f = a.apply(
        d,
        e
      )), (d = (e = null));
    };
    return function() {
      ...
      h || c.leading !== !1 || (h = j);
      var k = b - (j - h);
      return (d = this), (e = arguments), 0 >= k
        ? (clearTimeout(g), (g = null), (h = j), (f = a.apply(
            d,
            e
          )), (d = (e = null)))
        : g || c.trailing === !1 || (g = setTimeout(i, k)), f;
    };
  }
  var f = a(window),
    g = [],
  ...
  (a.scrollSpy = function(b, d) {
    ...
    (b = a(b)), b.each(function(b, c) {
      g.push(a(c)), a(c).data('scrollSpy:id', b), a(
        'a[href=#' + a(c).attr('id') + ']'
      ).click(function(b) {
        b.preventDefault();
    ...
    }), (d = d || { throttle: 100 }), (k.top = d.offsetTop ||
      0), (k.right = d.offsetRight || 0), (k.bottom = d.offsetBottom ||
      0), (k.left = d.offsetLeft || 0);
    var j = e(c, d.throttle || 100),
      l = function() {
        a(document).ready(j);
      };
    return i || (f.on('scroll', l), f.on('resize', l), (i = !0)), setTimeout(
      l,
      0
      ...
      var b = a(this);
      h[0]
        ? (a('a[href=#' + h[0].attr('id') + ']').removeClass('active'), b.data(
            'scrollSpy:id'
          ) < h[0].data('scrollSpy:id')
            ? h.unshift(a(this))
            : h.push(a(this)))
        : h.push(
            a(this)
  ...
  a(document).ready(function() {
    function b(b) {
      ...
      e &&
        d.css(
          'font-size',
          e
        ), c && d.css('font-family', c), 'off' === b.attr('wrap') && d.css('overflow-wrap', 'normal').css('white-space', 'pre'), d.text(b.val() + '\n');
    ...
    a('input[autofocus]').siblings('label, i').addClass('active'), a(
      document
    ).on('change', c, function() {
      (0 !== a(this).val().length || void 0 !== a(this).attr('placeholder')) &&
      ...
      var d = a(b.target);
      d.is('form') &&
        (d.find(c).removeClass('valid').removeClass('invalid'), d
          .find(c)
          .each(function() {
            '' === a(this).attr('value') &&
              a(this).siblings('label, i').removeClass('active');
      ...
      0 === b.val().length &&
        ...
        b
          ...
          .removeClass(
            'active'
          ), 0 === b.val().length && b[0].validity.badInput !== !0 && void 0 !== b.attr('placeholder') && b.siblings('i').removeClass('active'), validate_field(b);
    ...
    a(document).on('change', g, function(b) {
      ...
      var c = a(this).siblings('.thumb');
      c.length <= 0 &&
        ((c = a('<span class="thumb"><span class="value"></span></span>')), a(
          this
        ).append(
          c
        )), c.find('.value').html(a(this).val()), (h = !0), a(this).addClass('active'), c.hasClass('active') || c.velocity({ height: '30px', width: '30px', top: '-20px', marginLeft: '-15px' }, { duration: 300, easing: 'easeOutExpo' }), (f = void 0 === b.pageX || null === b.pageX ? b.originalEvent.touches[0].pageX - a(this).offset().left : b.pageX - a(this).offset().left);
      var d = a(this).outerWidth();
      0 > f
        ? (f = 0)
        : f > d &&
            (f = d), c.addClass('active').css('left', f), c.find('.value').html(a(this).val());
    ...
    function c(a, b, c) {
      var e = a.indexOf(b);
      -1 === e ? a.push(b) : a.splice(e, 1), c
        .siblings('ul.dropdown-content')
        .find('li')
        .eq(b)
        .toggleClass('active'), c.find('option').eq(b).prop('selected', !0), d(
        a,
        c
      );
    }
    ...
    a(this).each(function() {
      ...
      if (!d.hasClass('browser-default')) {
        ...
        if (
          (f &&
            (d.parent().find('span.caret').remove(), d
              .parent()
              .find('input')
              .remove(), d.unwrap(), a(
              'ul#select-options-' + f
        ...
        var i,
          ...
          l = [],
          m = !1;
        (i = void 0 !== d.find('option:selected')
          ? d.find('option:selected')
          : j.first()), k.each(function() {
          e
            ? j.append(
                a(
                  '<li class="' +
            ...
            a(this).hasClass('disabled') ||
              (e
                ? (a(
                    ...
                    return !b;
                  }), c(l, a(this).index(), g), p.trigger('focus'))
                : (j.find('li').removeClass('active'), a(this).toggleClass(
                    'active'
                  ), g
                    .siblings('input.select-dropdown')
                    .val(a(this).text())), activateOption(j, a(this)), g
                .find('option')
                .eq(f)
                .prop('selected', !0), g.trigger('change'), 'undefined' !=
                typeof b && b()), d.stopPropagation();
          });
        }), d.wrap(h);
        ...
        d.before(p), p.before(n), a('body').append(j), d.is(':disabled') ||
          p.dropdown({ hover: !1, closeOnClick: !1 }), d.attr('tabindex') &&
          a(p[0]).attr('tabindex', d.attr('tabindex')), d.addClass(
          'initialized'
        ), p.on({
          focus: function() {
            j.is(':visible') || a(this).trigger('open'), a('ul.select-dropdown')
              .not(j[0])
              .is(':visible') && a('input.select-dropdown').trigger('close');
          },
          click: function(a) {
            a.stopPropagation();
          },
          ...
          e ||
            a(this).trigger(
              'close'
            ), j.find('li.selected').removeClass('selected');
        }), j.hover(
          function() {
            m = !0;
          },
          ...
          b.find('li.selected').removeClass('selected'), a(c).addClass(
            'selected'
          );
        });
        var q = [],
          r = function(b) {
            ...
            if (13 != b.which || j.is(':visible')) {
              ...
              40 == b.which &&
                ((g = j.find('li.selected').length
                  ? j.find('li.selected').next('li:not(.disabled)')[0]
                  : j.find('li:not(.disabled)')[0]), activateOption(
                  j,
                  g
                )), 27 == b.which && p.trigger('close'), 38 == b.which &&
                ((g = j.find('li.selected').prev('li:not(.disabled)')[0]), g &&
                  activateOption(j, g)), setTimeout(
                function() {
                  q = [];
                },
                1e3
    ...
    init: function(b) {
      ...
      return (b = a.extend(c, b)), this.each(function() {
        ...
        function d(a) {
          a >= h.length
            ? (a = 0)
            : 0 > a && (a = h.length - 1), (i = g.find('.active').index()), i !=
            a &&
            ((e = h.eq(i)), ($caption = e.find('.caption')), e.removeClass(
              'active'
            ), e.velocity(
              { opacity: 0 },
              {
            ...
            ), c($caption, b.transition), b.indicators &&
              j.eq(i).removeClass('active'), h
              .eq(a)
              .velocity(
                { opacity: 1 },
            ...
            ), h.eq(a).addClass('active'), b.indicators &&
        ...
        if (
          (-1 != i && (e = h.eq(i)), f.hasClass('fullscreen') ||
            (b.indicators
              ? f.height(b.height + 40)
              : f.height(b.height), g.height(b.height)), h
            .find('.caption')
            .each(function() {
              c(a(this), 0);
          ...
          h.each(function(c) {
            ...
            e.click(function() {
              ...
              d(e), clearInterval($interval), ($interval = setInterval(
                function() {
                  (i = g.find('.active').index()), h.length == i + 1
                    ? (i = 0)
                    : (i += 1), d(i);
                },
        ...
        e
          ...
          : (h
              ...
              .velocity(
                { opacity: 1 },
                { duration: b.transition, queue: !1, easing: 'easeOutQuad' }
              ), (i = 0), (e = h.eq(i)), b.indicators &&
              j.eq(i).addClass('active')), e.find('img').each(function() {
          e
            .find('.caption')
            .velocity(
              { opacity: 1, translateX: 0, translateY: 0 },
        ...
        f
          ...
          .bind('pan', function(a) {
            if ('touch' === a.gesture.pointerType) {
              ...
              ($curr_slide = g.find('.active')), $curr_slide.velocity(
                { translateX: c },
                { duration: 50, queue: !1, easing: 'easeOutQuad' }
              ), 4 === b && (c > f.innerWidth() / 2 || -0.65 > d)
                ? (m = !0)
                : 2 === b &&
                    (c < -1 * f.innerWidth() / 2 || d > 0.65) &&
                    (l = !0);
              var e;
              l &&
                ((e = $curr_slide.next()), 0 === e.length &&
                  (e = h.first()), e.velocity(
                  { opacity: 1 },
                  { duration: 300, queue: !1, easing: 'easeOutQuad' }
                )), m &&
                ((e = $curr_slide.prev()), 0 === e.length &&
                  (e = h.last()), e.velocity(
                  { opacity: 1 },
                  { duration: 300, queue: !1, easing: 'easeOutQuad' }
                ));
          ...
          .bind('panend', function(a) {
            'touch' === a.gesture.pointerType &&
              (($curr_slide = g.find(
                '.active'
              )), (k = !1), (curr_index = g.find('.active').index()), m || l
                ? l
                    ? (d(curr_index + 1), $curr_slide.velocity(
    ...
    a.fn.pushpin = function(b) {
      ...
      return (b = a.extend(c, b)), ($index = 0), this.each(function() {
        function c(a) {
          a.removeClass(
            'pin-top'
          ), a.removeClass('pinned'), a.removeClass('pin-bottom');
        }
        function d(d, e) {
          d.each(function() {
            b.top <= e &&
              ...
              (c(a(this)), a(this).css('top', b.offset), a(this).addClass(
                'pinned'
              )), e < b.top && !a(this).hasClass('pin-top') && (c(a(this)), a(this).css('top', 0), a(this).addClass('pin-top')), e > b.bottom && !a(this).hasClass('pin-bottom') && (c(a(this)), a(this).addClass('pin-bottom'), a(this).css('top', b.bottom - g));
          });
        }
  ...
  var b = function(b) {
    if ((($this = b), $this.hasClass('active') === !1)) {
      ...
      e === !0 ? (d = 40) : (c = 40), $this.addClass('active'), $this
    ...
    c = function(a) {
      ...
      d === !0 ? (c = 40) : (b = 40), $this.removeClass('active'), $this
        .find('ul .btn-floating')
        .velocity('stop', !0), $this.find('ul .btn-floating').velocity(
        {
          opacity: '0',
          scaleX: '.4',
          scaleY: '.4',
  ...
  (Materialize.fadeInImage = function(b) {
    ...
    var c = 0;
    a(b).find('li').velocity({ translateX: '-100px' }, { duration: 0 }), a(b)
      .find('li')
      .each(function() {
        a(this).velocity(
        ...
        .bind('panend', function(d) {
          if (
            (Math.abs(d.gesture.deltaX) < a(this).innerWidth() / 2 &&
              ((c = !1), (b = !1)), 'touch' === d.gesture.pointerType)
          ) {
            var e = a(this);
            if (b || c) {
              var f;
  ...
  function b(f, g, i, l) {
    ...
    function n() {
      w
        ...
        .attr('tabindex', -1)
        .val(
          w.data('value') ? y.get('select', u.format) : f.value
        ), u.editable ||
        w
      ...
      y.$root
        .on({
          ...
          'mousedown click': function(b) {
            var c = b.target;
            c != y.$root.children()[0] &&
              (b.stopPropagation(), 'mousedown' != b.type ||
        ...
        .on(
          ...
          function() {
            var b = a(this),
              ...
              e = h();
            (e = e && (e.type || e.href)), (d ||
              (e && !a.contains(y.$root[0], e))) &&
              y.$root[0].focus(), !d && c.nav
              ? y.set('highlight', y.component.item.highlight, { nav: c.nav })
              : !d && 'pick' in c
                  ? y.set('select', c.pick)
                  : c.clear ? y.clear().close(!0) : c.close && y.close(!0);
          }
        ), e(y.$root[0], 'hidden', !0);
    }
    function p() {
      ...
      u.hiddenName === !0
        ...
        : ((b = [
            ...
            b[
              1
            ])), (y._hidden = a('<input type=hidden name="' + b + '"' + (w.data('value') || f.value ? ' value="' + y.get('select', u.formatSubmit) + '"' : '') + '>')[0]), w.on(
        'change.' + t.id,
        function() {
    ...
    function q(a) {
      ...
      return 27 == b
        ? (y.close(), !1)
        : void ((32 == b || c || (!t.open && y.component.key[b])) &&
      ...
      y = (x.prototype = {
        ...
        start: function() {
          return t && t.start
            ? y
            : ((t.methods = {
              }), (t.start = !0), (t.open = !1), (t.type = f.type), (f.autofocus = f ==
                h()), (f.readOnly = !u.editable), (f.id = f.id ||
                t.id), 'text' != f.type &&
                (f.type = 'text'), (y.component = new i(y, u)), (y.$root = a(
                b._.node(
                  'div',
                  m(),
                  v.picker,
              ...
              )), o(), u.formatSubmit && p(), n(), u.container
                ...
                .on({
                  ...
                  close: u.onClose,
                  set: u.onSet,
                }), (s = c(y.$root.children()[0])), f.autofocus &&
                y.open(), y.trigger('start').trigger('render'));
        },
        render: function(a) {
          return a
            ? y.$root.html(m())
        ...
        stop: function() {
          return t.start
            ? (y.close(), y._hidden &&
                ...
                .removeClass(v.input)
                .removeData(g), setTimeout(
                function() {
                  w.off('.' + t.id);
                },
                0
              ), (f.type = t.type), (f.readOnly = !1), y.trigger(
                'stop'
              ), (t.methods = {}), (t.start = !1), y)
            : y;
        },
        open: function(c) {
          return t.open
            ? y
            : (w.addClass(v.active), e(f, 'expanded', !0), setTimeout(
                function() {
                ...
                ((t.open = !0), s &&
                  k
                    .css('overflow', 'hidden')
                    .css('padding-right', '+=' + d()), y.$root[0].focus(), j
        ...
        close: function(a) {
          return a &&
            (y.$root.off('focus.toOpen')[0].focus(), setTimeout(
              function() {
                y.$root.on('focus.toOpen', r);
              },
              0
            )), w.removeClass(v.active), e(f, 'expanded', !1), setTimeout(
            function() {
              y.$root.removeClass(v.opened + ' ' + v.focused), e(
                y.$root[0],
                'hidden',
                !0
              );
            ...
            ? ((t.open = !1), s &&
                k.css('overflow', '').css('padding-right', '-=' + d()), j.off(
                '.' + t.id
              ), y.trigger('close'))
            : y;
        },
        ...
        set: function(b, c, d) {
          ...
          if (((d = g && a.isPlainObject(c) ? c : d || {}), b)) {
            g || (h[b] = c);
            for (e in h)
              (f = h[e]), e in y.component.item &&
                (void 0 === f && (f = null), y.component.set(
                  e,
                  f,
                  d
                )), ('select' == e || 'clear' == e) &&
                w.val('clear' == e ? '' : y.get(e, u.format)).trigger('change');
            y.render();
          }
        ...
        get: function(a, c) {
          ...
          if (a in y.component.item) {
            if ('string' == typeof c) {
              ...
              return d
                ? b._.trigger(y.component.formats.toString, y.component, [c, d])
                : '';
            }
        ...
        on: function(b, c, d) {
          ...
          if (b) {
            g || (h[b] = c);
            for (e in h)
              (f = h[e]), d && (e = '_' + e), (t.methods[e] = t.methods[e] || [
              ]), t.methods[e].push(f);
          }
          return y;
        },
  ...
  function c(a) {
    ...
    return a.currentStyle
      ? (b = a.currentStyle[c])
      : window.getComputedStyle && (b = getComputedStyle(a)[c]), 'fixed' == b;
  }
  function d() {
  ...
  return (b.klasses = function(a) {
    ...
    group: function(a) {
      for (
        ...
        (c = b._.trigger(a.item, a, [e])), (d += b._.node(
          a.node,
          c[0],
          c[1],
          c[2]
      ...
      .on(
        ...
        function() {
          ...
          c.disabled(c.get('now')) &&
            (d = ':not(.' + b.klass.buttonToday + ')'), a.$root
  ...
  (c.prototype.set = function(a, b, c) {
      ...
      : ((e['enable' == a ? 'disable' : 'flip' == a ? 'enable' : a] = d.queue[a]
          ...
          : 'highlight' == a
              ...
              : a.match(/^(flip|min|max|disable|enable)$/) &&
                  (e.select &&
                    d.disabled(e.select) &&
                    d.set('select', e.select, c), e.highlight &&
                    d.disabled(e.highlight) &&
                    d.set('highlight', e.highlight, c)), d);
  }), (c.prototype.get = function(a) {
    return this.item[a];
  }), (c.prototype.create = function(a, c, d) {
    var e, g = this;
    return (c = void 0 === c ? a : c), c == -(1 / 0) || c == 1 / 0
      ? (e = c)
      : b.isPlainObject(c) && f.isInteger(c.pick)
          ? (c = c.obj)
          : b.isArray(c)
              ? ((c = new Date(c[0], c[1], c[2])), (c = f.isDate(c)
                  ? c
                  : g.create().obj))
              : (c = f.isInteger(c) || f.isDate(c)
    ...
    return f.isInteger(a) || (a = e(a)), f.isInteger(c) ||
      (c = e(c)), f.isInteger(a) && b.isPlainObject(c)
      ? (a = [c.year, c.month, c.date + a])
      : f.isInteger(c) &&
          b.isPlainObject(a) &&
          (c = [a.year, a.month, a.date + c]), { from: e(a), to: e(c) };
  }), (c.prototype.withinRange = function(a, b) {
    return (a = this.createRange(a.from, a.to)), b.pick >= a.from.pick &&
      b.pick <= a.to.pick;
  }), (c.prototype.overlapRanges = function(a, b) {
    var c = this;
    return (a = c.createRange(a.from, a.to)), (b = c.createRange(
      b.from,
      b.to
    ...
    return (b = new Date()), c &&
      c.rel &&
      b.setDate(b.getDate() + c.rel), this.normalize(b, c);
    ...
    if (i || j) {
      for (
        j
          ...
          k &&
          k.month !== g &&
          ((f = k.year), (g = k.month)), (e = new Date(
          f,
          g + (d && d.nav ? d.nav : 0),
          1
        )), (f = e.getFullYear()), (g = e.getMonth());
      ...
      d = c.item.disable.filter(function(d) {
        return f.isInteger(d)
          ...
          : b.isArray(d) || f.isDate(d)
              ...
              : b.isPlainObject(d) ? c.withinRange(d, a) : void 0;
      });
    return (d = d.length &&
      !d.filter(function(a) {
    ...
    return b && 'string' == typeof b
      ? ((c && c.format) ||
          ((c = c || {}), (c.format = d.settings.format)), d.formats
          .toArray(c.format)
          .map(function(a) {
            var c = d.formats[a],
    ...
    return 'flip' == c
      ...
      : c === !1
          ...
          : c === !0
              ? (d.flipEnable(-1), (e = []))
              : c.map(function(a) {
                  for (var c, g = 0; g < e.length; g += 1) if (
                      d.isDateExact(a, e[g])
                    ) {
                      c = !0;
                      break;
    ...
    var b = this,
      ...
      n = g.max,
      o = (function(a, b) {
        return c.firstDay && (a.push(a.shift()), b.push(b.shift())), f.node(
          'thead',
          f.node(
            'tr',
            f.group({
                              ...
                              (function(b) {
                                return b.push(
                                  k.month == a.month
                                    ? c.klass.infocus
                                    : c.klass.outfocus
                                ), h.pick == a.pick && b.push(c.klass.now), d &&
                                  b.push(c.klass.selected), e &&
                                  b.push(c.klass.highlighted), g &&
                                  b.push(c.klass.disabled), b.join(' ');
                              })([c.klass.day]),
                              'data-pick=' +
                                a.pick +
                                ' ' +
  ...
  (a.fn.characterCounter = function() {
    return this.each(function() {
      ...
      e &&
        (a(this).on('input', b), a(this).on('focus', b), a(this).on(
          'blur',
          d
        ), c(a(this)));
    });
