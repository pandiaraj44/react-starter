...
(function(e) {
  ...
  e.fn.perfectScrollbar = function(n, i) {
    return this.each(function() {
      ...
      function c(e) {
        return P.minScrollbarLength &&
          (e = Math.max(
            e,
            P.minScrollbarLength
          )), P.maxScrollbarLength && (e = Math.min(e, P.maxScrollbarLength)), e;
      }
      function u() {
        var e = { width: I };
        (e.left = B
          ? M.scrollLeft() + E - C
          : M.scrollLeft()), N ? (e.bottom = _ - M.scrollTop()) : (e.top = Q + M.scrollTop()), H.css(e);
        ...
        Z
          ...
          : (t.left = B
              ...
              : $ +
                  M.scrollLeft()), G.css(t), U.css({ left: W, width: k - z }), J.css({ top: j, height: R - et });
      }
      function d() {
        M.removeClass(
          'ps-active-x'
      ...
      function b() {
        function e(e) {
          ...
          return (t === void 0 || o === void 0) &&
            ((t = -1 *
              e.originalEvent.wheelDeltaX /
              6), (o = e.originalEvent.wheelDeltaY /
              6)), e.originalEvent.deltaMode && 1 === e.originalEvent.deltaMode && ((t *= 10), (o *= 10)), t !== t && o !== o && ((t = 0), (o = e.originalEvent.wheelDelta)), [t, o];
        }
        function t(t) {
          if (l || !(M.find('select:focus').length > 0)) {
            var n = e(t), r = n[0], i = n[1];
            (o = !1), P.useBothWheelAxes
              ? O && !X
                  ? (i
                      ? M.scrollTop(M.scrollTop() - i * P.wheelSpeed)
                      : M.scrollTop(M.scrollTop() + r * P.wheelSpeed), (o = !0))
                  : X &&
                      !O &&
                      (r
              ...
              : (M.scrollTop(M.scrollTop() - i * P.wheelSpeed), M.scrollLeft(
                  M.scrollLeft() + r * P.wheelSpeed
                )), d(), (o = o || v(r, i)), o &&
        ...
        e(q).bind(K('keydown'), function(n) {
          if ((!n.isDefaultPrevented || !n.isDefaultPrevented()) && t) {
            ...
            if (!e(r).is(':input,[contenteditable]')) {
              ...
              M.scrollTop(M.scrollTop() - i), M.scrollLeft(
                M.scrollLeft() + l
              ), (o = v(l, i)), o && n.preventDefault();
            }
          }
        });
      }
      ...
      function m() {
        ...
        function o() {
          r ||
            (r = setInterval(
              function() {
                return x()
                  ? (M.scrollTop(M.scrollTop() + l.top), M.scrollLeft(
                      M.scrollLeft() + l.left
                    ), d(), void 0)
        ...
        function n() {
          r &&
            (clearInterval(
              r
            ), (r = null)), H.removeClass('in-scrolling'), G.removeClass('in-scrolling');
        }
        ...
        e(q).bind(K('selectionchange'), function() {
          ...
          if (i) {
            ...
            t.x < a.left + 3
              ...
              : t.x > a.right - 3
                  ? ((l.left = 5), H.addClass('in-scrolling'))
                  : (l.left = 0), t.y < a.top + 3
              ? ((l.top = 5 > a.top + 3 - t.y ? -5 : -20), G.addClass(
                  'in-scrolling'
                ))
              : t.y > a.bottom - 3
                  ? ((l.top = 5 > t.y - a.bottom + 3 ? 5 : 20), G.addClass(
                      'in-scrolling'
                    ))
                  : (l.top = 0), 0 === l.top && 0 === l.left ? n() : o();
          }
        });
      }
      function T(t, o) {
        ...
        function s(e) {
          if (a(e)) {
            w = !0;
            var t = i(e);
            (p.pageX = t.pageX), (p.pageY = t.pageY), (f = new Date().getTime()), null !==
              b && clearInterval(b), e.stopPropagation();
          }
        }
        function c(e) {
          if (!h && w && a(e)) {
        ...
        function u() {
          !h &&
            w &&
            ((w = !1), clearInterval(b), (b = setInterval(
              function() {
                return x()
        ...
        t &&
          (e(window).bind(K('touchstart'), r), e(window).bind(
            K('touchend'),
            l
          ), M.bind(K('touchstart'), s), M.bind(K('touchmove'), c), M.bind(
            K('touchend'),
            u
      ...
      function L() {
        M.unbind(
          K()
        ), e(window).unbind(K()), e(q).unbind(K()), M.data('perfect-scrollbar', null), M.data('perfect-scrollbar-update', null), M.data('perfect-scrollbar-destroy', null), U.remove(), J.remove(), H.remove(), G.remove(), (M = (H = (G = (U = (J = (X = (O = (E = (D = (C = (Y = (k = (W = (_ = (N = (Q = (R = (j = (V = (Z = ($ = (B = (K = null)))))))))))))))))))))));
      }
      function S() {
        d(), y(), p(), f(), w(), m(), b(), (ot || nt) &&
          T(
            ot,
            nt
          ), P.useKeyboard && h(), M.data('perfect-scrollbar', M), M.data('perfect-scrollbar-update', d), M.data('perfect-scrollbar-destroy', L);
      }
      var P = e.extend(!0, {}, o),
        M = e(this),
        x = function() {
      ...
      if (('object' == typeof n ? e.extend(!0, P, n) : (i = n), 'update' === i))
        return M.data('perfect-scrollbar-update') &&
          M.data('perfect-scrollbar-update')(), M;
      if ('destroy' === i)
        return M.data('perfect-scrollbar-destroy') &&
          M.data('perfect-scrollbar-destroy')(), M;
